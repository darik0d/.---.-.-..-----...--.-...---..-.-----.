...
Aangezien mijn implementatie Stochastic Hill Climbing gebruikt geeft het script niet telkens dezelfde output. Meestal kom ik met een fitness score van 75.12 op deze tekst:
```
